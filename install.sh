...
{
        cd /opt
        git clone https://github.com/soymariogutierrez/ASTPP.git
}
...
normalize_astpp ()
{
        ...
        if [ ${DIST} = "DEBIAN" ]; then
                ...
                sed -i '2i zend_extension ="/usr/lib/php/20180731/ioncube_loader_lin_7.4.so"' /etc/php/7.4/fpm/php.ini
                sed -i '2i zend_extension ="/usr/lib/php/20180731/ioncube_loader_lin_7.4.so"' /etc/php/7.4/cli/php.ini
                ...
                cp /usr/src/ioncube/ioncube_loader_lin_7.4.so /usr/lib64/php/modules/
                sed -i '2i zend_extension ="/usr/lib64/php/modules/ioncube_loader_lin_7.4.so"' /etc/php.ini
...
install_database ()
{
        ...
        mysql -uroot -p${MYSQL_ROOT_PASSWORD} astpp < ${ASTPP_SOURCE_DIR}/database/astpp-20200624.sql
