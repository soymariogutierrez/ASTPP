...
-- ------2021-05-27
INSERT INTO `menu_modules` (`id`, `menu_label`, `module_name`, `module_url`, `menu_title`, `menu_image`, `menu_subtitle`, `priority`) VALUES (NULL, 'Personalized Rates', 'custom_rates', 'personalized_rates/personalized_rates_list/', 'Tariff', 'Routes.png', '0', '40.8');
