  ...
  <div class="w-section inverse no-padding">
          ...
          <div class="w-box card py-3">
            ...
            <p><?= $fields;?></p>
               ...
               <a href="<?= base_url(); ?>local_number/local_number_download_sample_file/local_number_sample" class="btn btn-success btn-block"><i class="fa fa-download"></i> <?php echo gettext("Download"); ?></a>
                 ...
                 <div class="col-md-12">
                   <div class=" card col-md-12 p-0 mb-4">
                     <div class="pb-4" id="floating-label">
                       <h3 class="bg-secondary text-light p-3 rounded-top"><?php echo gettext("Import Local Number"); ?>:</h3>
              <div class="col-md-4 col-sm-12 float-left">
                  ...
                  <input type="hidden" name="username" value="<?= $this->session->userdata('username') ?>" />
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <div class="col-12 mt-4 d-flex">
                        <div class="col-md-6 float-left p-0" data-ripple="">
                ...
                <div class="col-sm-4">
							                	<label>
							                		<span class="mr-4 align-middle"><?php echo gettext("Skip Header"); ?>:</span>
         ...
         <div class="col-md-12">
              <div class="text-center">
                    <button class="btn btn-success" id="impoddrt_termination1" type="submit" name="action" value="Import"><?php echo gettext("Import"); ?></button>
                    <button class="btn btn-secondary mx-2" id="ok" type="button" name="action" value="Cancel" onclick="return redirect_page('/local_number/local_number_list/')"><?php echo gettext("Cancel"); ?></button> 
              </div>
                 </div>
              </div>
            </form>
                ...
                <div class="card p-4 table-responsive">
                  <table width="100%" border="1"  class="table table-bordered details_table table">
                   ...
                   echo "<tr><td colspan='".$cnt."'>";?>
                        <button type="button" class="btn btn-secondary mx-2 float-right"  value="Back" onclick="return redirect_page('/local_number/local_number_import/')"><?php echo gettext("Back"); ?></button>
                        <button type="submit" class="btn btn-success float-right" id="Process" value="Process"><?php echo gettext("Process"); ?></button>
                  <?php echo "</td></tr>";?> 
                 </table>
              </div>
            </form>  
