	...
	function get_local_number_form_fields($id=false) {
		...
		$form [gettext ( 'Information' )] = array (
				...
				array (
						...
						/* Nirali Issue ASTPPENT:2810 Local Number:- Province/State and City field is accepting any special character in create/edit local number.*/
								'trim|required|alpha_space_dash',
						/*END*/
						'tOOL TIP',
						'' 
				),
