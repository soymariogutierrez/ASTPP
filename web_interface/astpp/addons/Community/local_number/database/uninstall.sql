...
delete from `roles_and_permission` where `module_name`='local_number' AND `module_url`='local_number_list_customer' AND `login_type`=2;
DELETE FROM `translations` WHERE `module_name` = 'local_number';
