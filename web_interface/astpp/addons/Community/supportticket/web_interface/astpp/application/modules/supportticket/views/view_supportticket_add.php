...
<!-- Manish Issue no - 1769 ([Cian] - shortcut button is not working in create support ticket page) - Just commented below code -->
<!-- <script type="text/javascript">
$(function() {
...
function regvalidate(){   
	...
	//Manish Issue no 1774 (Support ticket - Admin - login - Services - support - multiple tickets having same ticket number gets generated for below case.) - Added loader
											...
											<div class="col-md-6 form-group">
												<label class="col-md-3 control-label p-0"><?php echo gettext("To"); ?> * </label>
													...
													<?
													 ...
													 $account_id = form_dropdown('account_id', $this->db_model->build_dropdown_invoices("id,first_name,last_name,number,company_name,type", " accounts", "where_arr", array("reseller_id" => "0","status"=>"0","deleted" => "0","type <>" => "2")), '');
													 echo $account_id;
													?>
