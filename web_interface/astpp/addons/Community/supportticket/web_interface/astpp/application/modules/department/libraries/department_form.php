...
//harsh_16_01
	    ...
	    array(gettext('Admin'), 'admin_user_id', 'SELECT', '','', 'tOOL TIP', 'Please Enter account number', 'id', 'first_name,last_name,number,company_name', 'accounts', 'build_concat_dropdown', 'where_arr', array("status" => "0", "deleted" => 0,'type'=>2,"id !="=>1),'multi'),
	    array(gettext('Sub Admin'), 'sub_admin_user_id', 'SELECT', '','', 'tOOL TIP', 'Please Enter account number', 'id', 'first_name,last_name,number,company_name', 'accounts', 'build_concat_dropdown', 'where_arr', array("status" => "0", "deleted" => 0,"Type"=>4),'multi'),
        );
//harsh_10_01
...
//harsh_16_01
        $form[gettext('Department User')] = array(
	    array(gettext('Admin'), 'admin_user_id', 'SELECT', '','', 'tOOL TIP', 'Please Enter account number', 'id', 'first_name,last_name,number,company_name', 'accounts', 'build_concat_dropdown', 'where_arr', array("status" => "0", "deleted" => 0,'type'=>2),'multi'),
