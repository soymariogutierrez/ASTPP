INSERT INTO `menu_modules` (`id`, `menu_label`, `module_name`, `module_url`, `menu_title`, `menu_image`, `menu_subtitle`, `priority`) VALUES (NULL, 'Custom Rates', 'custom', 'custom_rates/custom_rates_list/', 'Tariff', 'Routes.png', '0', '40.8');
